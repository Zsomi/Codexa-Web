export const translations = {
  hu: {
    ...
    technologies: {
      title: 'Technológiák',
      subtitle: 'A legmodernebb eszközökkel dolgozunk',
    ...
    portfolio: {
      title: 'Portfólió',
      subtitle: 'Néhány projekt amit elkészítettünk',
      view_demo: 'Oldal meglátogatása',
      view_code: 'Kód megtekintése',
      view_all: 'Összes projekt megtekintése',
      hexory_store: {
        name: 'HexoryStore',
        description: 'Webáruház platform előfizetéses modellel. Vállalkozások könnyedén létrehozhatnak saját online boltot.',
        tech: ['Laravel', 'Next.js']
      },
      party_zona: {
        name: 'PartyZóna',
        description: 'Hangosítás rendelő platform. Eseményekhez professzionális hangrendszer bérlés egyszerűen.',
        tech: ['Angular', 'Laravel']
      },
      bull_rugs: {
        name: 'Bull Rugs',
        description: 'Egyedi szőnyeg tervező és rendelő rendszer. Saját design alapján készülő prémium szőnyegek.',
        tech: ['Angular', 'Laravel']
      }
    },
...
Időkeret és költségvetési elvárások?`,
    ...
    footer: {
      ...
      copyright: '© 2025 Codexa. Minden jog fenntartva.'
    }
  },
  ...
  en: {
    ...
    technologies: {
      title: 'Technologies',
      subtitle: 'We work with the most modern tools',
    ...
    portfolio: {
      ...
      view_demo: 'Visit Website',
      view_code: 'View Code',
      view_all: 'View All Projects',
      hexory_store: {
        name: 'HexoryStore',
        description: 'E-commerce platform with subscription model. Businesses can easily create their own online store.',
        tech: ['Laravel', 'Next.js']
      },
      party_zona: {
        name: 'PartyZóna',
        description: 'Sound system rental platform. Professional audio equipment rental for events made simple.',
        tech: ['Angular', 'Laravel']
      },
      bull_rugs: {
        name: 'Bull Rugs',
        description: 'Custom carpet design and ordering system. Premium carpets made from your own designs.',
        tech: ['Angular', 'Laravel']
      }
    },
...
Timeline and budget expectations?`,
    ...
    footer: {
      ...
      copyright: '© 2025 Codexa. All rights reserved.'
    }
  }
};
