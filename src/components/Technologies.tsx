  ...
  {`]
          ...
          <div className={`flex flex-wrap justify-center gap-2 sm:gap-3 lg:gap-4 mt-6 sm:mt-8 px-2 transition-all duration-700 delay-300 ${isVisible ? 'scroll-slide-right scroll-visible' : 'scroll-slide-right'}`}>
            {[
              ...
              { name: 'Vue.js', icon: <VueIcon />, color: 'text-green-400' },
              { name: 'Angular', icon: <AngularIcon />, color: 'text-red-600' },
              { name: 'Nuxt.js', icon: <NuxtIcon />, color: 'text-green-500' },
              { name: 'Laravel', icon: <LaravelIcon />, color: 'text-red-500' },
              { name: 'Node.js', icon: <NodeIcon />, color: 'text-green-500' },
              { name: 'Express', icon: <ExpressIcon />, color: 'text-gray-300' },
              { name: '.NET', icon: <DotNetIcon />, color: 'text-purple-500' },
              { name: 'Docker', icon: <DockerIcon />, color: 'text-blue-500' },
              { name: 'Git', icon: <GitIcon />, color: 'text-orange-500' },
              { name: 'TailwindCSS', icon: <TailwindIcon />, color: 'text-cyan-400' }
            ].map((tech) => (
              <span
                key={tech.name}
