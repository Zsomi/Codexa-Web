          ...
          {portfolioProjects.map((project, index) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                {/* Action button */}
                <button className="w-full bg-gray-700 hover:bg-gray-600 text-white font-mono text-sm py-2 px-4 rounded transition-colors duration-300 group-hover:bg-blue-600">
