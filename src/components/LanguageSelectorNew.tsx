...
const BritishFlag = () => (
  <svg width="20" height="15" viewBox="0 0 20 15" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M10,0 V15 M0,7.5 H20" stroke="#FFFFFF" strokeWidth="2"/>
    <path d="M0,0 L20,15 M20,0 L0,15" stroke="#C8102E" strokeWidth="0.5"/>
    <path d="M10,0 V15 M0,7.5 H20" stroke="#C8102E" strokeWidth="1"/>
  </svg>
);
...
export default function LanguageSelector() {
  ...
  const languages = [
    ...
    { code: 'en' as Language, label: 'English', flag: <BritishFlag /> }
  ];
